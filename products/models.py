...
class Ingredients(models.Model):
    ...
    has_sub_ingredient = models.BooleanField(
...
class Product(models.Model):
    ...
    sale_price = models.DecimalField(max_digits=6, decimal_places=2,
                                     null=True, blank=True)
    medium_sale_price = models.DecimalField(max_digits=6, decimal_places=2,
                                            null=True, blank=True)
    large_sale_price = models.DecimalField(max_digits=6, decimal_places=2,
                                           null=True, blank=True)
    in_stock = models.BooleanField(default=False, null=True, blank=True)
    image_url = models.URLField(max_length=1024, null=True, blank=True)
    image = models.ImageField(null=True, blank=True)
    ingredients = SortedManyToManyField('Ingredients',
                                        db_column='friendly_name', blank=True)
